// OVER_LIMIT_JUSTIFIED: Berisi modul utama koperasi simpan pinjam warga terintegrasi dengan kalkulator sisa hasil usaha (SHU), tabungan warga, dan workflow kredit mikro.
