  ...
  return (
    <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100 hover:border-orange-200 transition-all group">
      ...
      <button 
        ...
        className="w-full py-2 min-h-[44px] bg-white border border-gray-200 rounded-xl flex items-center justify-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-600 hover:bg-orange-600 hover:text-white hover:border-orange-600 transition-all active:scale-95 shadow-sm"
      >
        <Plus size={14} />
        Tambah
      </button>
