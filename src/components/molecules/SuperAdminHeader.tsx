...
export function SuperAdminHeader({ stats }: SuperAdminHeaderProps) {
  return (
    <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white p-4 rounded-3xl shadow-2xl overflow-hidden relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-3">
          ...
          <div className="flex gap-3">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 px-2 py-2 rounded-2xl">
